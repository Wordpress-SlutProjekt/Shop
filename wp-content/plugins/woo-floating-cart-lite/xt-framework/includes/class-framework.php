...
abstract class XT_Framework
{
    ...
    public function freemius_plugin_params()
    {
        $menu = array(
    ...
    {
        $_page = ( !empty($_GET['page']) ? filter_input( INPUT_GET, 'page', FILTER_SANITIZE_STRING ) : '' );
        $_tab = ( !empty($_GET['tab']) ? filter_input( INPUT_GET, 'tab', FILTER_SANITIZE_STRING ) : '' );
