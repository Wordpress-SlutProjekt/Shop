...
$query = new WP_Query( array(
            ...
            while ( $query->have_posts() ) : $query->the_post(); 
                            ...
                            echo    '<li><a href="'.$img.'" class="image-popup"><span class="arrow_expand"></span></a></li>';
                            
                            echo    '<li><a href="#"><span class="icon_heart_alt"></span></a></li>'; 
                            echo    '<li><a href="'.get_the_permalink().'"><span class="icon_bag_alt"></span></a></li>';
                            echo    '</ul>';
                            ...
                            echo '<div class="product__price">'.$price.' kr'.'</div>';
                            echo '</div>';
                            echo '</div>';
                            echo '</div>';
